        ...
        <div class="containerhehe">
            <div class="portion1">
                ...
                <div class="portion1_2 maintitleFontFamily">
                    ...
                    <span class="editbuttonn"><a class="aStyle" href="staff_editUserInfo.php?id=<?php echo $_GET['id']; ?>">edit</a></span>
                </div>
            </div>
            <div class="portion2">
                    ...
                    if ($sheltername != "") { ?>
                        ...
                        <div class="portion2_2">
                            <ul>
                                ...
                                <a class="moreInfo" href="staff_shelterinfo.php?id=<?php echo $shelterDetials['shelter_id']; ?>">more details</a>
                            </ul>
                        </div>
                <?php } ?>
                ...
                <br><br>
                <div class="portion3">
                    <a class="aStyle" href="staffInfo_userInfo.php"><div class="removeAct">Back</div></a>
                    <a class="aStyle" href="staff_removeUser.php?id=<?php echo $_GET['id']; ?>" onClick="return confirm('Confirm to delete ?')"><div class="removeAct">Remove account</div></a>
                </div>
                <br><br>
            </div>
        </div>
